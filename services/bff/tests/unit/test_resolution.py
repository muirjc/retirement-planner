...
def _scenario(name="base_case", roth_conversion=None, state="FL"):
    return Scenario(
        ...
        accounts=[
            Account(account_type="traditional", balance=1_000_000),
            Account(account_type="traditional", balance=500_000),
            Account(account_type="roth", balance=400_000),
            Account(account_type="taxable", balance=200_000),
        ],
